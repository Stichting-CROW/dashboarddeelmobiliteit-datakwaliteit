...
| [GO Sharing](https://github.com/Stichting-CROW/dashboarddeelmobiliteit-datakwaliteit/blob/main/provider/GoSharing.md)         | 🔴           | :heavy_check_mark: MDS       | ❌                 | ❌           | ❌  | ❌
...
| [TIER](https://github.com/Stichting-CROW/dashboarddeelmobiliteit-datakwaliteit/blob/main/provider/TIER.md)                    | ➖           | :heavy_check_mark: MDS              | ❌ | ❔                         | ❌ |
| Urbee                                                                                                                         | ⏳           | ➖              | ➖                | ➖                 | ➖ |
