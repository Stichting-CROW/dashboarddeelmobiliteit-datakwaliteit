...
| Updated    | Description
| ----       | ---
| 2022-03-23 | TIER emails: "We logged in into the CROW Dashboard. If I see it correctly there're 5% difference between the data of TIER and the CROW Dashboard data of Eindhoven/Amersfoort. CROW Dashboard number of rentals are lower, CROW Dashboard amount of active vehicles is higher. In Utrecht there's a bigger difference in the number of active vehicles: 10+ more vehicles than there should be.<br /><br />We think it's good to see how CROW Dashboard sees rentals and active vehicles, so we can share this with our data team. Please share a raw data export of the cities as well, so we can analyse the data."
